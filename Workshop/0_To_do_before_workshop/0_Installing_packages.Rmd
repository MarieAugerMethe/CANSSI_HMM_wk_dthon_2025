...
The remaining packages should be easily installed or updated via CRAN (using install.packages()):
...
library(hmmTMB)      # fitting HMMs
library(tidyverse)   # data management
library(kableExtra)  # produce visually appealing tables
library(ggspatial)   # plotting of spatial data
library(geosphere)   # to calculate step lengths from lat/lon locations
library(terra)       # updated raster package
library(tidyterra)   # data management
```
