...
One of the advantage of the package `hmmTMB` is its capacity to incorporate complex and non-linear relationship with covariates. Here, `~s(TOD, bs="cc")` represents TOD using a cyclic spline.
