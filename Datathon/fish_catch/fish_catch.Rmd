...
If interested in rate of change (i.e., rate of decline), abundance may not be the variable to model. Instead, you may want to consider rate of change in abundance. In addition, think about how the covariates could be included in the model (linear vs other options related to heat tolerance of the fish) and the potential for interactions between temperature and fishing mortality. One potential difficulty is that there may be only one rapid decline period per time series, which may limit the ability of the model to identify it.
